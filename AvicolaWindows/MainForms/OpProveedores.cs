...
namespace AvicolaWindows
{
    public partial class OpProveedores : Explorador
    {
        ...
        private void ActualizarInv()
        {
            ...
            string cmd2 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art1, cant1);
            string cmd3 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art2, cant2);
            string cmd4 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art3, cant3);
            string cmd5 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art4, cant4);
            string cmd6 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art5, cant5);
            string cmd7 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art6, cant6);
            string cmd8 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art7, cant7);
            string cmd9 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art8, cant8);
            string cmd10 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art9, cant9);
            string cmd11 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art10, cant10);
            string cmd12 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art11, cant11);
            string cmd13 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art12, cant12);
            string cmd14 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art13, cant13);
            string cmd15 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art14, cant14);
            string cmd16 = string.Format("EXEC OpProvInvCancel '{0}', '{1}'", art15, cant15);
